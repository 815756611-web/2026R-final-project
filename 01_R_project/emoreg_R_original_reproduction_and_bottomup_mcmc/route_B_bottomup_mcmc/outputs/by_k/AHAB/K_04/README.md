...
- mean_loglik：-9738.498
- requested_K：4
- occupied_K：2
- effective_K：1
- empty_cluster_count：2
- BIC 近似值：20026.57
- delta_BIC：292.3052；越接近 0 表示相对支持越强。
- overall_score：0.6772
- 归属稳定性得分：0.969
- 共聚类结构得分：1
- 可解释性得分：0.7328
- 是否为 overall_recommended_K：FALSE
- mean_membership_entropy：0.0386；越低表示分类越清晰。
- kept_draws：2000
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| 1 | common-appraisal-like | 58 | 0.999 | 0.1535 |  0.0545 | 100 | 54.2296 |
| 2 | modifiable-emotion-like | 3 | 0.674 | 0.4449 | -0.0864 | 100 | 69.4840 |
