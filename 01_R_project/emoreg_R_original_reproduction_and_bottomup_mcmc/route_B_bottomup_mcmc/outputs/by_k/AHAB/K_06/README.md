...
- mean_loglik：-9733.944
- requested_K：6
- occupied_K：2
- effective_K：2
- empty_cluster_count：4
- BIC 近似值：20296.91
- delta_BIC：562.6442；越接近 0 表示相对支持越强。
- overall_score：0.6531
- 归属稳定性得分：0.9979
- 共聚类结构得分：1
- 可解释性得分：0.6911
- 是否为 overall_recommended_K：FALSE
- mean_membership_entropy：0.0107；越低表示分类越清晰。
- kept_draws：2000
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| 1 | modifiable-emotion-like | 3 | 1.0000 | 0.4449 | -0.0864 | 100 | 69.4840 |
| 2 | common-appraisal-like | 58 | 0.9985 | 0.1535 |  0.0545 | 100 | 54.2296 |
