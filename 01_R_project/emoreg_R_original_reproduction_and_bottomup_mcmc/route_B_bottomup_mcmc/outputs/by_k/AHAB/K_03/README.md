...
- mean_loglik：-9733.134
- requested_K：3
- occupied_K：2
- effective_K：2
- empty_cluster_count：1
- BIC 近似值：19876.12
- delta_BIC：141.8544；越接近 0 表示相对支持越强。
- overall_score：0.9162
- 归属稳定性得分：1
- 共聚类结构得分：1
- 可解释性得分：0.7744
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| 1 | common-appraisal-like | 58 | 1 | 0.1535 |  0.0545 | 100 | 54.2296 |
| 2 | modifiable-emotion-like | 3 | 1 | 0.4449 | -0.0864 | 100 | 69.4840 |
