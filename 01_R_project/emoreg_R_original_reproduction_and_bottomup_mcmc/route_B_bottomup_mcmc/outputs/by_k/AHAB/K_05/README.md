...
- mean_loglik：-9736.167
- requested_K：5
- occupied_K：2
- effective_K：2
- empty_cluster_count：3
- BIC 近似值：20161.63
- delta_BIC：427.3663；越接近 0 表示相对支持越强。
- overall_score：0.6285
- 归属稳定性得分：0.9893
- 共聚类结构得分：1
- 可解释性得分：0.7078
- 是否为 overall_recommended_K：FALSE
- mean_membership_entropy：0.0401；越低表示分类越清晰。
- kept_draws：2000
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| 1 | common-appraisal-like | 58 | 0.998 | 0.1535 |  0.0545 | 100 | 54.2296 |
| 2 | modifiable-emotion-like | 3 | 0.810 | 0.4449 | -0.0864 | 100 | 69.4840 |
