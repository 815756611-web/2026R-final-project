...
- mean_loglik：-10323.66
- requested_K：3
- occupied_K：2
- effective_K：2
- empty_cluster_count：1
- BIC 近似值：21055.69
- delta_BIC：143.319；越接近 0 表示相对支持越强。
- overall_score：0.8399
- 归属稳定性得分：0.9979
- 共聚类结构得分：1
- 可解释性得分：0.7695
- 是否为 overall_recommended_K：FALSE
- mean_membership_entropy：0.0075；越低表示分类越清晰。
- kept_draws：2000
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| 1 | emotion-generation-stable-mixed | 3 | 1.000 | 0.2145 | -0.0284 | 100.000 |  3.3948 |
| 2 | common-appraisal-like | 58 | 0.999 | 0.0867 |  0.0398 |  68.453 | 18.1302 |
