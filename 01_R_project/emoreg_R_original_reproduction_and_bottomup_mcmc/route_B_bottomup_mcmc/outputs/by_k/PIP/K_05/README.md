...
- mean_loglik：-10328.05
- requested_K：5
- occupied_K：2
- effective_K：1
- empty_cluster_count：3
- BIC 近似值：21342.92
- delta_BIC：430.5411；越接近 0 表示相对支持越强。
- overall_score：0.6976
- 归属稳定性得分：0.9689
- 共聚类结构得分：1
- 可解释性得分：0.7028
- 是否为 overall_recommended_K：FALSE
- mean_membership_entropy：0.0394；越低表示分类越清晰。
- kept_draws：2000
- 是否为当前 tag 下最低 BIC：FALSE
- 请求的 K 值：5
- 实际非空 cluster 数：2
- 空 cluster 数：3
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| 1 | common-appraisal-like | 58 | 0.9995 | 0.0867 |  0.0398 |  68.453 | 18.1302 |
| 2 | emotion-generation-stable-mixed | 3 | 0.6140 | 0.2145 | -0.0284 | 100.000 |  3.3948 |
...
- `empty_clusters.csv`：当前 K 下未分到任何 ROI 的空 cluster 记录。
