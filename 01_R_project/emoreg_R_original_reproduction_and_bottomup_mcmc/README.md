...
- 保留 `01_R_project` 中的路线 A/B 代码、现有输出、日志和文档。
- 不上传 `data` 里的原始/处理中数据文件。
- 数据来源链接见 `data/raw/SOURCE_DATA_LINKS.txt`。
- 原实验资料与原 MATLAB 代码链接见仓库中的 `02_source_materials/.../SOURCE_LINK.txt`。
